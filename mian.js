document.addEventListener("DOMContentLoaded", () => {
    ...
    const products = [
      ...
      { id: 3, name: "sư tử", price: 150000, image: "https://img.lazcdn.com/g/p/23b93967c73b07f89479b9c0e9b9ddbd.jpg_720x720q80.jpg" },
      { id: 4, name: "Gấu trúc Panda Pan-pan", price: 120000, image: "https://salt.tikicdn.com/cache/w1200/ts/product/f6/b4/45/98b96c369ee193b8aff04120e776ea15.jpg" },
      { id: 5, name: "gấu We Bare Bears ", price: 180000, image: "https://salt.tikicdn.com/cache/w1200/ts/product/7d/5f/ff/534872e4b9274eedb298cf0b9d7f9a24.jpg" },
      { id: 6, name: "Gấu Trắng", price: 220000, image: "https://down-vn.img.susercontent.com/file/a8915607b8b4db44211dcb4b3d2e8d1d" },
      { id: 7, name: "Heo bảy màu", price: 250000, image: "https://pos.nvncdn.com/0d9756-7239/ps/20211018_fzzXcN5HKHpEvL52uEpPlEft.jpg" },
      { id: 8, name: "Chồi non", price: 130000, image: "https://down-vn.img.susercontent.com/file/9d27acf62707af24785792bcd4ba05dc" }];
    ...
    const createChatWidget = () => {
      ...
      const getAutoResponse = (userMsg) => {
        ...
        if (userMsg.toLowerCase().includes("hello") || userMsg.toLowerCase().includes("chào")) {
          return "Xin chào! shop Cẩm TúTú có thể giúp gì cho bạn?";
        }
        if (userMsg.toLowerCase().includes("giá")) {
          return "Bạn có thể xem giá sản phẩm ở mục sản phẩm của shop Cẩm Tú. Nếu cần tư vấn, hãy cho shop Cẩm Tú biết!";
        }
        return "Cảm ơn bạn đã liên hệ, shop Cẩm Tú sẽ phản hồi sớm.";
      };
    };
    createChatWidget();
